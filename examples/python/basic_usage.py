...
def using_openai_sdk():
    ...
    try:
        ...
        client = OpenAI(
            api_key=API_KEY,
            base_url=GATEWAY_BASE_URL  # Point to LLM Gateway
        )
...
def main():
    ...
    print("Make sure to:")
    print("1. Start the LLM Gateway server (npm run dev)")
    print("2. Replace 'your-api-key-here' with your actual API key")
    print("3. Configure provider API keys in your environment\n")
